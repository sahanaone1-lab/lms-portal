...
let QuizzesController = class QuizzesController {
    ...
    create(req, body) {
        return this.quizzesService.create(body.courseId, body.title, body.passingScore, body.questions, req.user.id, req.user.role, body.timeLimit, body.weekId);
    }
    update(id, req, body) {
