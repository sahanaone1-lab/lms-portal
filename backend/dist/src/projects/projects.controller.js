...
let ProjectsController = class ProjectsController {
    ...
    create(req, body) {
        return this.projectsService.create(body.title, body.description, body.domain, req.user.id);
    }
    findAll(req) {
        return this.projectsService.findAll(req.user.id, req.user.role, req.user.domain);
    }
    registerInterest(id, req) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ProjectsController.prototype, "registerInterest", null);
__decorate([
