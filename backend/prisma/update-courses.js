...
async function updateCourse(domain, newTitle, newDescription, newDuration, modules, lessons, assignments) {
...
async function main() {
    ...
    await updateCourse('Machine Learning', 'Machine Learning Training Program', 'Industry-Oriented Machine Learning Course — 120 Hours. Master Python, Data Analysis, Supervised & Unsupervised Learning, Deep Learning, and Model Deployment through hands-on projects and real-world capstone challenges.', '120 Hours', mlModules, mlLessons, mlAssignments);
    await updateCourse('Digital Marketing', 'Digital Marketing Professional Training Program', 'Industry-Oriented Digital Marketing Course — 120 Hours. Master SEO, Google Ads, Meta Ads, Social Media Marketing, Content Marketing, Email Automation, and Analytics through live campaigns and a capstone project.', '120 Hours', dmModules, dmLessons, dmAssignments);
    await updateCourse('Cyber Security', 'Cyber Security Training Program', 'Industry-Oriented Cyber Security Course — 120 Hours. Master Networking, Ethical Hacking, Penetration Testing, Web App Security, SOC Operations, Digital Forensics, Cloud Security, and Security Automation with real lab environments.', '120 Hours', csModules, csLessons, csAssignments);
    console.log('\n✅ All 3 courses updated successfully!');
}
main()
    .catch((e) => { console.error(e); process.exit(1); })
    .finally(async () => { await prisma.$disconnect(); });
//# sourceMappingURL=update-courses.js.map