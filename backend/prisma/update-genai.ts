...
// ─── Generative AI Modules — 14 Modules ───────────────────────────────────────
...
async function updateGenerativeAICourse() {
  ...
  // Find course by domain "Generative AI" or "Gen AI"
  ...
  if (!course) {
    ...
    // Find an Admin or Coordinator to assign as project coordinator
  ...
  await prisma.quiz.create({
    data: {
      ...
      courseId: course.id,
      weekId: 'genai_m14',
      questions: genaiQuizQuestions as any,
    },
  });
