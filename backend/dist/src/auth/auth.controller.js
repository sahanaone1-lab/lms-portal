...
let AuthController = class AuthController {
    ...
    async register(body) {
        return this.authService.register(body.name, body.email, body.role, body.password, body.domain);
    }
    ...
    async refresh(req, res) {
        ...
        try {
            ...
            const data = await this.authService.refreshTokens(payload.sub, refreshToken);
            res.cookie('refreshToken', data.refreshToken, {
                httpOnly: true,
                secure: process.env.NODE_ENV === 'production',
                sameSite: 'lax',
